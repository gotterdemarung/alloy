...
class ChainNodeTest extends AlloyTest
{
    ...
    {
        $x = new ChainNode(array(1, true, 'str'));
        $this->assertTrue($x->containsValue(true));
        $this->assertFalse($x->containsValue(false));
        $this->assertTrue($x->containsValue(1));
        $this->assertFalse($x->containsValue(2));
        $this->assertTrue($x->containsValue('str'));
        $this->assertFalse($x->containsValue('sss'));
        $this->assertTrue($x->containsValue(new ChainNode(true)));
        $this->assertFalse($x->containsValue(new ChainNode(false)));
    }
